...
class CorgeTest {
    ...
    static void beforeAll() {
        CorgeTest.corgeClass = Utils.testIfClassExists("com.jad.com.jad.Corge");
    }
    ...
    void fooAttributeTest() {
        Utils.testIfPrivateAttributeExistsWithGoodType("com.jad.com.jad.Foo", "foo", CorgeTest.corgeClass);
    }
